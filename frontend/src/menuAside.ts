...
const menuAside: MenuAsideItem[] = [
  ...
  {
    href: '/discussions/discussions-list',
    label: 'Discussions',
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    icon: icon.mdiForum ? icon.mdiForum : icon.mdiTable,
    permissions: 'READ_DISCUSSIONS',
  },
  {
    href: '/housing_transit_scores/housing_transit_scores-list',
    label: 'Housing transit scores',
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    icon: icon.mdiChartBar ? icon.mdiChartBar : icon.mdiTable,
    permissions: 'READ_HOUSING_TRANSIT_SCORES',
  },
  {
