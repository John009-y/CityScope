...
const CardDiscussions = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_DISCUSSIONS');
        ...
        {!loading &&
          discussions.map((item, index) => (
            ...
            >
              ...
              >
                <Link
                  href={`/discussions/discussions-view/?id=${item.id}`}
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    onDelete={onDelete}
                    itemId={item.id}
                    pathEdit={`/discussions/discussions-edit/?id=${item.id}`}
                    pathView={`/discussions/discussions-view/?id=${item.id}`}
...
export default CardDiscussions;
