...
const EditDiscussions = () => {
  ...
  const { discussionsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: discussionsId }));
  }, [discussionsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: discussionsId, data }));
...
EditDiscussions.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditDiscussions;
