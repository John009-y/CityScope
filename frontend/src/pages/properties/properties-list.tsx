...
const PropertiesTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    { label: 'RentPrice', title: 'rent_price', number: 'true' },

    { label: 'Reports', title: 'reports' },
  ]);

  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_PROPERTIES');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          {hasCreatePermission && (
            <BaseButton
              className={'mr-3'}
              href={'/properties/properties-new'}
              color='info'
              label='New Item'
            />
          )}
...
export default PropertiesTablesPage;
